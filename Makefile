...
JMX_OPTS := -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=38082 -Dcom.sun.management.jmxremote.local.only=false -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false
